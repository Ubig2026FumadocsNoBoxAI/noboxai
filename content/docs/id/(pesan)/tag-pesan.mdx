...
2\. Klik ikon <img src="/images/id/information%20icon.png" alt="Informasi" className="inline h-5 w-auto mx-1" /> maka akan tampil detail dari percakapan tersebut. Klik pada bagian Tag Pesan maka akan tampil data tag yang telah dibuat sebelumnya atau tambahkan tag baru.
