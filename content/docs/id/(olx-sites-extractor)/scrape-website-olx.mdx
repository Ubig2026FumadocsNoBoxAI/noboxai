...
<ImageZoom
  src="/images/id/New%20Acccount%20OLX.png"
...
<Tips>
  ## **Tips Penggunaan** Tips untuk memudahkan proses pemindaian data di website
  OLX: - Pastikan Anda sudah menentukan lokasi yang spesifik sebelum memulai
  pencarian agar data lebih akurat. - Gunakan kategori yang paling relevan
  dengan jenis produk atau jasa yang sedang Anda riset. - Atur Limit Result
  sesuai dengan kebutuhan data harian Anda agar proses scraping tetap stabil. -
  Centang opsi Load Images hanya jika Anda benar-benar membutuhkan data visual
  untuk meminimalisir penggunaan memori. - Kelola daftar hasil ekstraksi dengan
  fitur 'Save to List' agar tidak tercampur dengan proyek riset lainnya.
</Tips>
---
<Kendala>
  ## **Penanganan Kendala** Apabila menemui masalah saat melakukan scraping
  website OLX: - Jika proses scraping tidak berjalan, pastikan username dan
  password untuk fitur Auto Login sudah diisi dengan benar. - Apabila browser
  Chrome yang digunakan extractor mengalami error, coba matikan aplikasi lalu
  jalankan kembali. - Jika jumlah data yang didapat lebih sedikit dari limit,
  kemungkinan sistem menyaring iklan yang dipasang oleh pemilik yang sama. -
  Periksa koneksi internet Anda jika data gagal tersimpan ke menu Contacts di
  NoBox.AI secara real-time. - Restart aplikasi NoBox Desktop jika terjadi
  kendala pada sinkronisasi antar tab extractor.
</Kendala>
