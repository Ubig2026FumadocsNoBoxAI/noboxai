...
- Pilih tipe input yang sesuai (misalnya 'Number' untuk nominal atau nomor) untuk menjaga validitas data.
...
Jika terjadi kendala pada menu Inputan Khusus:
 
- Refresh halaman jika inputan khusus yang baru dibuat tidak langsung muncul di form kontak atau produk.
