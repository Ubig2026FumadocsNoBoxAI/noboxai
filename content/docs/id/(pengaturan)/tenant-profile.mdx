...
- Pastikan data alamat dan kontak perusahaan selalu diperbarui untuk akuntansi dan keperluan resmi lainnya.
- Gunakan fitur 'Unduh Data' secara berkala sebagai bentuk cadangan (backup) database lokal perusahaan Anda.
...
- Manfaatkan fitur 'Grup Agen' untuk membagi beban kerja percakapan secara merata di dalam tim.
...
Jika mengalami masalah terkait pengaturan Profil Usaha:
