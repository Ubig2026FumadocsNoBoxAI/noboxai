...
- Gunakan fitur impor Excel/CSV untuk memindahkan data kontak secara massal dengan cepat.
- Pastikan ID Eksternal di-mapping dengan benar (seperti nomor telepon atau email) agar data tidak duplikat.
- Manfaatkan fitur vCard untuk berbagi informasi kontak dengan aplikasi lain.
- Gunakan tab Tugas dan Penawaran untuk melacak aktivitas dan progres penjualan yang terkait dengan kontak.
- Tambahkan catatan di setiap interaksi agar histori komunikasi dengan kontak tetap terekam dengan baik.
...
- Jika impor gagal, pastikan format file sudah sesuai dengan model yang diunduh.
- Refresh halaman jika kontak yang baru ditambahkan tidak muncul di daftar.
- Periksa hak akses Anda jika tidak dapat melakukan edit atau hapus pada data tertentu.
- Pastikan koneksi internet stabil saat melakukan sinkronisasi dengan Google Kontak.
- Hubungi tim support jika tautan (link) eksternal seperti WhatsApp atau Email tidak berfungsi.
