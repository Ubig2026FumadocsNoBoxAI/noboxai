...
<table>
  ...
  <tbody>
    <tr>
      <td><img src="/images/Tombol Papan (1).png" alt="" /></td>
      <td>Digunakan untuk tambah papan.</td>
    </tr>
    <tr>
      <td><img src="/images/Tombol penawaran.png" alt="" /></td>
      <td>Digunakan untuk tambah penawaran.</td>
    </tr>
    <tr>
      <td><img src="/images/titik tiga.png" alt="" /></td>
      <td>Digunakan untuk menampilkan pop up edit dan hapus data papan.</td>
    </tr>
    <tr>
      <td><img src="/images/Tombol kanban.png" alt="" /></td>
      <td>Digunakan untuk menampilkan dalam bentuk kanban.</td>
    </tr>
    <tr>
      <td><img src="/images/list.png" alt="" /></td>
...
Untuk tambah data papan, silahkan klik tombol **[**<img src="/images/Tombol Papan (1).png" alt="" />**]**, maka akan tampil dialog **[Add Pipeline]**.

<ImageZoom
  src="/images/id/tambah papan penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
Gunakan icon <img src="/images/titik tiga.png" alt="" />:  
- **Edit** untuk mengubah data  
- **Hapus** untuk menghapus data (konfirmasi muncul)

## **Tambah Penawaran**

Klik tombol <img src="/images/Tombol penawaran.png" alt="" /> untuk menambah penawaran.

<ImageZoom
  src="/images/id/tambah penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
Klik tombol <img src="/images/Comment.png" alt="" /> untuk menambahkan komentar.

<ImageZoom
  src="/images/id/tambah komentar penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
Untuk edit/hapus komentar gunakan icon <img src="/images/Edit Delete2.png" alt="" />.  
- **Edit** → ubah komentar → klik **Send**  
- **Remove** → hapus komentar → konfirmasi dialog muncul

## **Salin Penawaran**

Klik icon <img src="/images/Setting.png" alt="" /> → **Copy** untuk menyalin penawaran.

<ImageZoom
  src="/images/id/Tampilan Copy penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
Klik tombol <img src="/images/Tombol Tugas.png" alt="" /> untuk menambah tugas.

<ImageZoom
  src="/images/id/tampilan tugas penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/tampilan transaksi penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/tampilan pengeluaran penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/tampilan catatan penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/tampilan log penawaran.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
