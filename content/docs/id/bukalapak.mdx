...
<ImageZoom
  src="/images/id/Account%20Bukalapak.png"
...
<ImageZoom
  src="/images/id/Login%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/Auto%20Login%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/Outbox%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/Inbox%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/Jeda%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
...
<ImageZoom
  src="/images/id/Nonaktif%20Bukalapak.png"
  alt="Tampilan Dasbor NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
