...
Untuk membuka NoBox Desktop, Anda dapat login dari akun yang sudah Anda buat di website [id.nobox.ai](https://id.nobox.ai/) sebelumnya.
...
- Jika belum memiliki akun silahkan ikuti panduan yang ada di [Registrasi](crm-user-registration)
