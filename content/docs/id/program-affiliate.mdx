...
<ImageZoom
  src="/images/id/affiliate%20withdraw/request.png"
  alt="Tampilan Berlangganan NoBox"
  width={800}
  height={450}
  className="rounded-lg border shadow-sm mb-4"
