...
To change a member's role, please click the **\[Members]** tab, select a member, and click the icon \[[![](/images/en/role%201.png)](/images/en/role%201.png)] A dialog will appear to edit member roles, check the desired role.
