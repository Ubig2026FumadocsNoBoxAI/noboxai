...
To add task data, please click [ <img src="/images/en/New%20Task.png" alt="Add Task" className="inline h-5 w-auto mx-1" /> ] A **[New Task]** dialog will appear. Then complete the fields in the dialog.
