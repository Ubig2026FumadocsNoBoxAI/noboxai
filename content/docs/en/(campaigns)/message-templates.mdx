...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Message</td>
      <td>Enter message</td>
      <td>Good afternoon, regarding the special Ramadan promotion, our store has prepared abundant stock. Please list the requirements for the store so we can arrange the shipment before the stock runs out. Thank you.</td>
    </tr>
    <tr>
      <td>Attachment</td>
